...
namespace mr
{
    ...
    public:
         ...
         * @param range_max maximum sensor range
         */
        void compute_weights(const std::vector<std::pair<tuw::Point2D, tuw::Polar2D>> &z_s, const tuw::Pose2D &pose_sensor, double range_max);
    ...
    protected:
        ...
        double compute_expected_measurment(const tuw::Polar2D &z_i, const tuw::Tf2D &M, double range_max);
        ...
        /**
         * computes a lookup for the  pseudo density function
         *  @param range_max max measurment used to define the size of the lookup 
         */
        void compute_pseudo_density_lookup(double range_max);
        ...
        cv::Mat_<float> pseudo_density_fnc_;        /// lookup pseudo-density function
        cv::Mat_<uint8_t> expected_measurments_;    /// computed expected mesurments
